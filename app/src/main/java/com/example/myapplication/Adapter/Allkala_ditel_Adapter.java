...
public class Allkala_ditel_Adapter extends RecyclerView.Adapter< Allkala_ditel_Adapter.MyViewHolder> {
    Context context ;
    List < OffAmazing > data;

    public Allkala_ditel_Adapter ( Context context , List< OffAmazing > data ) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder ( @NonNull View itemView ) {
            super ( itemView );
            imageView_off =itemView.findViewById ( R.id.img_ditel);
            textView_name =itemView.findViewById ( R.id.text_ditel_name );
            textView_pric =itemView.findViewById ( R.id.diteli_price );
            textView_off =itemView.findViewById ( R.id.diteli_price_off);
