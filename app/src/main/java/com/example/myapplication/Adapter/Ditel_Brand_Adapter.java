...
public class Ditel_Brand_Adapter extends RecyclerView.Adapter< Ditel_Brand_Adapter.MyViewHolder> {
    Context context ;
    List < Ditel_category > data;

    public Ditel_Brand_Adapter ( Context context , List< Ditel_category > data ) {
    ...
    public MyViewHolder onCreateViewHolder ( @NonNull ViewGroup parent , int viewType ) {
        View view = LayoutInflater.from ( context ).inflate ( R.layout.item_ditel_barand,parent,false );
